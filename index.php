...
<html>
	...
	<body>
		...
		<div id="overlay">
			<form>
				<div class="row">
					<div class="col-md-3 col-sm-3 col-lg-4 col-xs-1"></div>
					<div class="col-md-5 col-sm-5 col-lg-3 col-xs-8">
						<input type="text" id="input-search" placeholder="O que você procura?" class="form-control">
					</div>
					<div class="col-md-1 col-sm-1 col-lg-1 col-xs-2 form-group">
